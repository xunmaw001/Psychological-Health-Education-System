  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">心理健康教育系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='zixunshi'">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='zixunshi'">
			...
			<el-form-item label="等级" class="input" v-if="tableName=='zixunshi'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.zhanghao) && `zixunshi` == this.tableName){
        ...
        return
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            if(`zixunshi` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
