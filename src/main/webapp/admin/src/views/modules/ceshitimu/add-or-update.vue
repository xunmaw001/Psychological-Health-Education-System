      ...
      <el-row>
          ...
          <el-form-item class="input" label="名称" prop="mingcheng">
              <el-input v-model="ruleForm.mingcheng" 
                placeholder="名称" readonly></el-input>
                                                                                                                                                                                          ...
                                                                                                                                                                                          <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="测试文件" prop="ceshiwenjian">
          <file-upload
          tip="点击上传测试文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.ceshiwenjian" label="测试文件" prop="ceshiwenjian">
            <el-button type="text" size="small" @click="download(ruleForm.ceshiwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.timu" label="题目" prop="timu">
                    <span>{{ruleForm.timu}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="题目1" prop="timu1">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="题目1"
                  v-model="ruleForm.timu1" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.timu1" label="题目1" prop="timu1">
                    <span>{{ruleForm.timu1}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="题目2" prop="timu2">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="题目2"
                  v-model="ruleForm.timu2" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.timu2" label="题目2" prop="timu2">
                    <span>{{ruleForm.timu2}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="题目3" prop="timu3">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="题目3"
                  v-model="ruleForm.timu3" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.timu3" label="题目3" prop="timu3">
                    <span>{{ruleForm.timu3}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="题目4" prop="timu4">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="题目4"
                  v-model="ruleForm.timu4" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.timu4" label="题目4" prop="timu4">
                    <span>{{ruleForm.timu4}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ceshitimu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ceshitimuCrossAddOrUpdateFlag = false;
                  this.parent.search();
