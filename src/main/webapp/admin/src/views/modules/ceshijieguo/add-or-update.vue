  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="健康程度" prop="jiankangchengdu">
          <el-select v-model="ruleForm.jiankangchengdu" placeholder="请选择健康程度">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="健康程度" prop="jiankangchengdu">
	      <el-input v-model="ruleForm.jiankangchengdu"
                placeholder="健康程度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                <el-col :span="12">
          ...
          <el-form-item class="input" label="咨询师姓名" prop="zixunshixingming">
              <el-input v-model="ruleForm.zixunshixingming" 
                placeholder="咨询师姓名" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="测试结果" prop="ceshijieguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="测试结果"
                  v-model="ruleForm.ceshijieguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ceshijieguo" label="测试结果" prop="ceshijieguo">
                    <span>{{ruleForm.ceshijieguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                  ...
                                                                                                                  this.jiankangchengduOptions = "正常,轻微,一般,严重,重度".split(',')
                                                                                                    },
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
        url: `ceshijieguo/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ceshijieguo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ceshijieguoCrossAddOrUpdateFlag = false;
                  this.parent.search();
